...
useEffect(() => {
  ...
  const fetchProperties = async () => {
    try {
      const response = await fetch('https://estate-70yd.onrender.comapi/getproperties'); // Replace with your endpoint
  ...
  const handleSaleTypeChange = async (e, propertyId) => {
    ...
    try {
      const response = await fetch(`https://estate-70yd.onrender.comapi/update-sale-type/${propertyId}`, {
        method: 'PUT',
        headers: {
                ...
                <div className="shad p-3">
                  <div className="artists-image-wrap">
                    {property.coverImageUrl ? (
                      <img
                        src={`https://estate-70yd.onrender.com${property.coverImageUrl}`}
