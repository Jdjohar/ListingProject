  ...
  const handleEditorChange = (event, editor) => {
   ...
   const handleSubmit = async (e) => {
    ...
    try {
        ...
        const uploadResponse = await fetch("https://estate-70yd.onrender.comapi/upload", {
            method: 'POST',
            body: formData,
        });
        ...
        const coverUploadResponse = await fetch("https://estate-70yd.onrender.comapi/upload-cover", {
        method: 'POST',
        body: coverFormData,
        });
        ...
        const response = await fetch("https://estate-70yd.onrender.comapi/addproperty", {
            method: 'POST',
            headers: {
